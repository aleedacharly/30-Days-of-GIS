...
Approx. 118 square kilometers urban area with a population of ~600,000.
![Calicut Map](outputs/landuse_map.png)
## Data Sources
| Dataset              | Source                  | Link                        |
|----------------------|-------------------------|-----------------------------|
...
- Out of the total features fetched from OSM, approximately 57% were classified as Other — 6020 out of roughly 10,598 features. This is a striking number and carries a clear message: OSM contributors in Kozhikode have mapped the geometry of buildings and parcels diligently, but have not consistently attached semantic tags like landuse=residential or building=commercial to those geometries. The shape exists in the database, but its meaning does not.
